...
export default function HowItWorks() {
  ...
  // Refs for top step navigation + each step button
  ...
  useEffect(() => {
    ...
    // Center the active step in the scroll strip
        ...
        <div className="mt-10 overflow-hidden rounded-[1.5rem] border border-slate-200 bg-[#d9ebe7] p-2 shadow-[0_25px_70px_rgba(11,34,63,0.12)] sm:mt-14 sm:rounded-[2rem] sm:p-3">
          <div className="rounded-[1.25rem] bg-white p-4 sm:rounded-[1.5rem] sm:p-6 lg:p-8">
            ...
            <div className="mt-6 grid gap-5 sm:mt-8 sm:gap-6 lg:grid-cols-[0.75fr_1.25fr]">
              ...
              ========================== */}
              <div className="flex flex-col justify-center rounded-[1.25rem] bg-[#0b223f] p-5 text-white sm:rounded-[1.5rem] sm:p-8 lg:p-9">
                <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#128276] text-sm font-extrabold sm:h-12 sm:w-12 sm:text-lg">
                  {activeStep.number}
                </div>

                <p className="mt-5 text-[10px] font-bold uppercase tracking-[0.18em] text-[#8ed6ca] sm:mt-7 sm:text-xs">
                  LabourFlow Workflow
                </p>

                <h3 className="mt-2 text-lg font-extrabold tracking-tight sm:mt-3 sm:text-2xl lg:text-3xl">
                  {activeStep.title}
                </h3>

                {/* Short description shown on LEFT */}
                <p className="mt-2.5 text-sm leading-6 text-white/65 sm:mt-4 sm:text-base sm:leading-7">
                  {activeStep.shortDescription}
                </p>

                {/* Footer check — hidden on mobile to save height */}
                <div className="mt-6 hidden items-center gap-3 text-xs font-semibold text-[#8ed6ca] sm:mt-7 sm:flex sm:text-sm">
              ...
              {/* =========================
                  ...
                  (swipeable on mobile)
              ========================== */}
              <div className="relative min-h-[300px] touch-pan-y overflow-hidden rounded-[1.25rem] border border-slate-200 bg-[#f7faf9] p-4 sm:min-h-[380px] sm:rounded-[1.5rem] sm:p-6 lg:p-7">
                ...
                <div className="relative">
                  ...
                  <div className="hidden items-center justify-between gap-3 border-b border-slate-200 pb-4 sm:flex sm:pb-5">
                    <div className="min-w-0">
                      <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#128276]">
                        {activeStep.number} / {data.steps.length}
                      </p>

                      <h4 className="mt-1 truncate text-base font-extrabold text-[#0b223f] sm:text-xl">
                        {activeStep.title}
                      </h4>
                    </div>
                  ...
                  <div className="mt-0 grid gap-3 sm:mt-6 sm:grid-cols-2 sm:gap-4">
                    ...
                    <div className="rounded-2xl hidden lg:grid sm:grid border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
                      ...
                      <p className="mt-3 text-base font-extrabold text-[#0b223f] sm:mt-5 sm:text-lg">
                        {activeStep.title}
                      </p>
                    ...
                    {/* STEP-SPECIFIC INFORMATION — shown from sm up */}
                    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:block">
                  ...
                  {/* Mobile swipe hint — only on phone */}
                  <div className="mt-4 flex items-center justify-center gap-2 text-[10px] font-semibold text-slate-400 sm:hidden">
                    <Icon name="arrow" className="rotate-180 text-[10px]" />
                    <span>Swipe to change step</span>
